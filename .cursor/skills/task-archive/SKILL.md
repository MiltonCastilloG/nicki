---
name: task-archive
description: "Write docs/archive/<slug>/ (report.yaml, report.md, story.md); erase spec and subtasks. Use before close-scope teardown."
...
3. Note missing integrate pointer; if override approved, set `meta.tail_override` in report.yaml.
4. Draft `report.yaml` — task, story, outcome, process, decisions, open_questions, suggestions.
...
Then close-scope unregister + teardown.
