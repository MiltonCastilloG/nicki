...
> **Superseded (2026-07-29; gate retired 2026-08-05).** Historical Task briefs from the harness write-contract
...
> - Harness: **read** (`bootstrap-context.py`) + **write** (`update-status.py`); no spawn gate
> - Consent: Nicki chat for execute + sync — [`2026-08-05-retire-check-gate-design.md`](superpowers/specs/2026-08-05-retire-check-gate-design.md)
