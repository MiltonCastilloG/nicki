...
**Date:** 2026-07-17  
**Status:** Decided and shipped (Jul 14); docs aligned Jul 17; **partially superseded 2026-07-29**; **gate type retired 2026-08-05**  
...
> `--mode normal|adhoc|jump`; see [`flexibility.md`](../../flexibility.md).
> **2026-08-05:** spawn `check-gate.py` deleted — harness is **read + write** only;
> consent is Nicki chat (execute + sync). See
> [`2026-08-05-retire-check-gate-design.md`](2026-08-05-retire-check-gate-design.md).
