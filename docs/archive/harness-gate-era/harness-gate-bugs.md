...
> **Historical (2026-08-05).** Spawn-time `check-gate.py` / `gates.py` were **retired**. Live harness is read (`bootstrap-context.py`) + write (`update-status.py`); consent is Nicki chat for execute + sync. See [`2026-08-05-retire-check-gate-design.md`](superpowers/specs/2026-08-05-retire-check-gate-design.md) and [`archive/retire-check-gate/`](archive/retire-check-gate/). Keep this file for bug archaeology only.
...
Scope (at time of writing): `check-gate.py`, `gates.py`, `gate_utils.py`, `bootstrap-context.py`,
